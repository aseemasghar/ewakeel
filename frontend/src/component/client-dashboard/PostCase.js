...
<div className="m-2 mb-0 col-md-6">
  ...
  <input value={title}  onChange={(e) => setTitle(e.target.value)} type="text" className="form-control" id="title" placeholder="e.g Dispute in Business Partnerships"/>
</div>
...
<div className="m-2 mb-0 col-md-6">
  ...
  <input value={city}
          onChange={(e) => setCity(e.target.value)}  type="text" className="form-control" id="city" placeholder="e.g Islamabad"/>
</div>
...
<div className="row d-flex justify-content-center">
  ...
  <textarea value={description}
          onChange={(e) => setDescription(e.target.value)} className="form-control" id="text-area" rows="6"></textarea>
</div>
</div>
<div className="row m-3 d-flex justify-content-center">
<button disabled={loading} type="submit" className="col-md-6 w-25 btn btn-primary">Submit</button>
</div>
