...
const passwordSubmitHandler = (e) => {
  ...
  const submitHandler = async (e) => {
    e.preventDefault();
    await dispatch(updateProfile(avatar,name, email,phone,address,city,state,country ));
    dispatch(loadUser());
  };
...
<form onSubmit={submitHandler}>
          ...
          <div className="m-3 row">
            ...
            <div className="col-md-4">
              <div className="input-group mb-3">
                <input type="file" className="form-control" id="avatar"  accept="image/*" onChange={handleImageChange} />
        ...
        <div className="address my-2  border border-secondary">
          ...
          <div className="m-3 row my-4">
            <div className="col">
              ...
              <select onChange={(e) => setState(e.target.value)} id="inputState" className="form-select">
              <option>...</option>
            ...
            <div className="col">
              ...
              <select onChange={(e) => setCountry(e.target.value)}  id="inputCountry" className="form-select">
                <option>...</option>
        ...
        <button disabled={updateLoading} type="submit" className="w-25 my-3 p-2 btn btn-dark">Submit Information</button>
        </form>
...
<form onSubmit={passwordSubmitHandler}>
    ...
    <input type="password" className="form-control" id="old-password" value={oldPassword}
                onChange={(e) => setOldPassword(e.target.value)}/>
  </div>
  <div className="col-md-4 mb-3">
    <label htmlFor="new-password" className="form-label">New Password</label>
    <input type="password" className="form-control" id="new-password" value={newPassword}
                onChange={(e) => setNewPassword(e.target.value)}/>
  </div>
  <div className="col-md-4 mb-3">
    <label htmlFor="repeat-password" className="form-label">Repeat Password</label>
    <input type="password" className="form-control" id="repeat-password" value={confirmPassword}
  ...
  <p className="mx-1 row">Enter same password in both fields. Use an uppercase letter and a number for stronger password.</p>
      ...
      <button disabled={loading} type="submit" className=" w-25 my-3 p-2 btn btn-dark">Update</button>
      </form>
